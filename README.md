...
| `search_tools` | **Find the few tools relevant to what you're doing** instead of scanning all ~170 — keyword/phrase in (`"graphql"`, `"jwt"`, `"cache poisoning"`), a short ranked list out (name match > family > gist). Progressive discovery for a large tool surface. |
