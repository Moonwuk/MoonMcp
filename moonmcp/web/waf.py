...
_SIGNATURES: dict[str, list[tuple[str, str]]] = {
    ...
    # NB: the passive scan matches these against a NORMAL page body, so a generic
    # "not acceptable" (any 406 page / prose) would fingerprint benign sites as
    # ModSecurity — keep only the distinctive mod_security tokens here.
    "ModSecurity": [("server", "mod_security"), ("server", "modsecurity"),
                    ("body", "mod_security"), ("body", "this error was generated by mod_security")],
