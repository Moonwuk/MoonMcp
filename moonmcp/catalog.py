...
FAMILIES: OrderedDict[str, tuple[str, str, list[str]]] = OrderedDict([
    ...
    ("light_active", (
        ...
        [
            ...
            "jarm_fingerprint", "ja4_fingerprint", "origin_discovery", "behavior_probe",
            ...
            "nextjs_middleware_probe", "debug_exposure",
            "actuator_probe", "appliance_cve_probe",
            "screenshot", "browser_open", "browser_eval", "browser_interact", "cspp_probe",
            "analyze_binary", "analyze_config", "jwt_analyze", "jwt_crack", "jwt_alg_confusion",
    ...
    ("intrusive", (
        ...
        [
            ...
            "graphql_nosqli", "sspp_probe", "unicode_bypass_probe", "bitrix_ssrf_probe",
        ],
    )),
    ("orchestration", (
        "Orchestration",
