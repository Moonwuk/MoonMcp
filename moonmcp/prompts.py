...
OPERATING_LOOP = (
    ...
    "   (`injection_info` / `technique_info`) and prior findings.\n"
    ...
    "   (baseline diff, re-test, confirm error signatures) — Chain-of-Verification.\n"
    "6. RECORD: persist confirmed findings with `add_finding` (severity + evidence), and\n"
    "   keep a short decision log — do not repeat an approach that already failed.\n"
...
def bug_bounty_operator(target: str = "example.com", focus: str = "") -> str:
    ...
    return (
        ...
        "- Config & auth: `analyze_config`, `jwt_analyze`, `cors_audit`, `http_methods`.\n"
